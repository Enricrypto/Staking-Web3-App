...
INSTRUCTIONS: 
1.⁠ ⁠deploy deposit and reward token on arbitrum + verify ✅
2.⁠ ⁠deploy staking contract and verify on arbitrum ✅
3.⁠ ⁠read balances of depositToken, rewardToken and stakingToken and Display it in the app ✅
4.⁠ ⁠add a button to mint depositToken ✅
5.⁠ ⁠Add Buttons to deposit and withdraw from staking ✅
6.⁠ ⁠add button to claim 
7.⁠ ⁠Show the user how many reward Tokens they have accrued before claiming
8. Create input fields
